export const sleep = (minutes: number): Promise<void> => {
...
export const priceDiff = (
  ...
  const p0: number =
    typeof price0 === "string" ? Number.parseFloat(price0) : price0;
  const p1: number =
    typeof price1 === "string" ? Number.parseFloat(price1) : price1;
